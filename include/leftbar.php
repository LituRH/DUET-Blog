...
<?php 
 ...
 ?> 
						...
						<li><?php  echo "<a href='#' onclick='login()'>$row[1]</a>"; ?> 
                        </a></li>
					    <?php } ?>
                    </ul>
				</li>
				...
				<li>
					...
					<ul>
						     <?php
$result = mysql_query("select * from comments ORDER BY comment DESC LIMIT 5") or die(mysql_error());
 while($row = mysql_fetch_array($result))
 {
 ?> 
<li><?php  echo "<a href='#' onclick='login()'>$row[3]</a>"; ?> 
                        </a></li>
<?php } ?>
